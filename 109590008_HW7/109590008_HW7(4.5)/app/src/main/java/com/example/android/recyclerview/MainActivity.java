...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 3; i++) {
            if (i==0)
                mWordList.addLast("Bubble Tea");
                mWordList2.addLast("The most famous drink in Taiwan.");
            if (i==1)
                mWordList.addLast("Fried Rice");
                mWordList2.addLast("The most popular food in Taiwan.");
            if (i==2)
                mWordList.addLast("Stinky Tofu");
                mWordList2.addLast("The smelliest food in Taiwan.");
        }
